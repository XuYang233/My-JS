...
// @resource        baiduCommonStyle     http://ibaidu.htt5.com/newcss/baiduCommonStyle.css?t=24.01
// @resource        baiduOnePageStyle    http://ibaidu.htt5.com/newcss/baiduOnePageStyle.css?t=24.01
// @resource        baiduTwoPageStyle    http://ibaidu.htt5.com/newcss/baiduTwoPageStyle.css?t=24.01
// @resource        baiduLiteStyle       http://ibaidu.htt5.com/newcss/baiduLiteStyle.css?t=24.01
// @resource        googleCommonStyle    http://ibaidu.htt5.com/newcss/googleCommonStyle.css?t=24.01
// @resource        googleOnePageStyle   http://ibaidu.htt5.com/newcss/googleOnePageStyle.css?t=24.01
// @resource        googleTwoPageStyle   http://ibaidu.htt5.com/newcss/googleTwoPageStyle.css?t=24.01
// @resource        bingCommonStyle      http://ibaidu.htt5.com/newcss/bingCommonStyle.css?t=24.01
// @resource        bingOnePageStyle     http://ibaidu.htt5.com/newcss/bingOnePageStyle.css?t=24.01
// @resource        bingTwoPageStyle     http://ibaidu.htt5.com/newcss/bingTwoPageStyle.css?t=24.01
// @resource        sogouCommonStyle     http://ibaidu.htt5.com/newcss/sogouCommonStyle.css?t=24.01
// @resource        sogouOnePageStyle    http://ibaidu.htt5.com/newcss/sogouOnePageStyle.css?t=24.01
// @resource        sogouTwoPageStyle    http://ibaidu.htt5.com/newcss/sogouTwoPageStyle.css?t=24.01
// @resource        duckCommonStyle      http://ibaidu.htt5.com/newcss/duckCommonStyle.css?t=24.01
// @resource        duckOnePageStyle     http://ibaidu.htt5.com/newcss/duckOnePageStyle.css?t=24.01
// @resource        duckTwoPageStyle     http://ibaidu.htt5.com/newcss/duckTwoPageStyle.css?t=24.01
// @resource        dogeCommonStyle      http://ibaidu.htt5.com/newcss/dogeCommonStyle.css?t=24.01
// @resource        dogeOnePageStyle     http://ibaidu.htt5.com/newcss/dogeOnePageStyle.css?t=24.01
// @resource        dogeTwoPageStyle     http://ibaidu.htt5.com/newcss/dogeTwoPageStyle.css?t=24.01
// @resource        MainHuYanStyle       http://ibaidu.htt5.com/newcss/HuYanStyle.css?t=24.01
// @resource        SiteConfigRules      http://ibaidu.htt5.com/newcss/SiteConfigRules.conf?t=24.01
...
!function () {
    ...
    (function () {
        ...
        let DefaultConfig = {
            ...
            AdsStyleMode_Doge: 3, // 0-不带css；1-单列靠左；2-单列居中；3-双列居中
            ...
            HuYan_Doge: false, // 护眼模式-DuckGOGO
            ...
            !function () {
                ...
                if (ACConfig.AdsStyleEnable) {
                    if (curSite.SiteTypeID == SiteType.BAIDU) {
                        ...
                        CONST.AdsStyleMode = ACConfig.AdsStyleMode_Doge;
                        CONST.HuYanMode = ACConfig.HuYan_Doge;
                        CONST.keySite = "doge";
                                    ...
                                    <ul class="setting-main" v-show="!other.showSecondPanel">
                                        ...
                                        <li>
                                            ...
                                            <label class="container-label doge">
                                                ...
                                                <label style="margin-left:20px"><input name="sp-ac-a_force_style_doge" v-model="ACConfig.AdsStyleMode_Doge" value="0" type="radio">
                                                {{ lan.use.fieldset_panel.setting_panel.userStyle_doge_origin }}
                                                </label>
                                                <label :title="lan.use.fieldset_panel.setting_panel.userStyle_doge_huyan"><input name="sp-ac-huyan_style_doge" v-model="ACConfig.HuYan_Doge" type="checkbox">
                                                ...
                                                <br>
                                                <label style="margin-left:20px">
                                                <input name="sp-ac-a_force_style_doge" value="1" v-model="ACConfig.AdsStyleMode_Doge" type="radio">
                                                {{ lan.use.fieldset_panel.setting_panel.userStyle_doge_1line }}
                                                </label>
                                                <label><input name="sp-ac-a_force_style_doge" value="2" v-model="ACConfig.AdsStyleMode_Doge" type="radio">
                                                {{ lan.use.fieldset_panel.setting_panel.userStyle_doge_1line_enter }}
                                                </label>
                                                <label><input name="sp-ac-a_force_style_doge" value="3" v-model="ACConfig.AdsStyleMode_Doge" type="radio" checked="">
                                                {{ lan.use.fieldset_panel.setting_panel.userStyle_doge_2line }}
                                                </label>
                                                <label><input name="sp-ac-a_force_style_doge" value="4" v-model="ACConfig.AdsStyleMode_Doge" type="radio">
                                                {{ lan.use.fieldset_panel.setting_panel.userStyle_doge_3line }}
                                                </label>
                                                <label><input name="sp-ac-a_force_style_doge" value="5" v-model="ACConfig.AdsStyleMode_Doge" type="radio">
            ...
            function FSBaidu() { // thanks for code from 浮生@未歇 @page https://greasyfork.org/zh-TW/scripts/31642
                ...
                CONST.StyleManger = {
                    ...
                    loadTwoPageStyle: function () {
                        ...
                        AC_addStyle(cssHead + "{grid-template-columns: repeat(auto-fit,minmax(50%,1fr));} #container #content_left>*:not([class*='result']):last-child, #rso>div:not(.g), #rso .srg, #links .result--more,.AC.sp-separator{grid-column-start: 1;grid-column-end: 3;}",
                            "AC-TwoPageStyle", "head");
                    },
                    // 加载三列样式
                    loadThreePageStyle: function () {
                        ...
                        if (curSite.SiteTypeID == SiteType.DUCK) cssHead = "#links_wrapper .results--main #links";
                        if (curSite.SiteTypeID == SiteType.DOGE) cssHead = "#links_wrapper .results--main #links";
                        AC_addStyle(cssHead + "{grid-template-columns: repeat(auto-fit,minmax(33%,1fr));} #container #content_left>*:not([class*='result']):last-child, #rso>div:not(.g), #rso .srg, #links .result--more,.AC.sp-separator{grid-column-end: 4;}",
                    ...
                    loadFourPageStyle: function () {
                        ...
                        if (curSite.SiteTypeID == SiteType.SOGOU) cssHead = "#main .results";
                        if (curSite.SiteTypeID == SiteType.DOGE) cssHead = "#links_wrapper .results--main #links";
                        AC_addStyle(cssHead + "{grid-template-columns: repeat(auto-fit,minmax(25%,1fr));} #container #content_left>*:not([class*='result']), #rso>div:not(.g), #rso .srg, #links .result--more,.AC.sp-separator{grid-column-end: 5;}",
